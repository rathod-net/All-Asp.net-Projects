    ...
    public partial class mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CuisineMasterId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cuisines", x => x.CuisineMasterId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurantCuisines", x => new { x.RestaurantId, x.CuisineMasterId });
                    table.ForeignKey(
                        name: "FK_RestaurantCuisines_Cuisines_CuisineMasterId",
                        column: x => x.CuisineMasterId,
                        principalTable: "Cuisines",
                        principalColumn: "CuisineMasterId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Cuisines",
                columns: new[] { "CuisineMasterId", "CuisineName", "ImageUrl", "IsActive" },
                values: new object[,]
                {
                    { 1, "Indian", null, true },
                    { 2, "Chinese", null, true },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestaurantCuisines_CuisineMasterId",
                table: "RestaurantCuisines",
                column: "CuisineMasterId");
